...
public class keyvaluestore extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "JHS.zxScannerLiveView.keyvaluestore");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", JHS.zxScannerLiveView.keyvaluestore.class).invoke(this, new Object[] {null});
        else
...
public ResumableSub_GetMapAsync(JHS.zxScannerLiveView.keyvaluestore parent,anywheresoftware.b4a.objects.collections.List _keys) {
this.parent = parent;
this._keys = _keys;
}
JHS.zxScannerLiveView.keyvaluestore parent;
...
parent.__c.LogImpl("935717143",BA.ObjectToString(parent.__c.LastException(parent.getActivityBA())),0);
 if (true) break;
...
public ResumableSub_PutMapAsync(JHS.zxScannerLiveView.keyvaluestore parent,anywheresoftware.b4a.objects.collections.Map _map) {
this.parent = parent;
this._map = _map;
}
JHS.zxScannerLiveView.keyvaluestore parent;
...
parent.__c.LogImpl("935782664","Failed to serialize object: "+BA.ObjectToString(_map.Get((Object)(_key))),0);
 if (true) break;
