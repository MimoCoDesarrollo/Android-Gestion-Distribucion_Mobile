...
public class b4xtableselections extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "JHS.zxScannerLiveView.b4xtableselections");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", JHS.zxScannerLiveView.b4xtableselections.class).invoke(this, new Object[] {null});
        else
...
public JHS.zxScannerLiveView.b4xorderedmap _selectedlines = null;
public int _selectioncolor = 0;
public JHS.zxScannerLiveView.b4xtable _mtable = null;
...
public String  _initialize(anywheresoftware.b4a.BA _ba,JHS.zxScannerLiveView.b4xtable _table) throws Exception{
innerInitialize(_ba);
...
{
final anywheresoftware.b4a.BA.IterableList group9 = _mtable._visiblecolumns /*anywheresoftware.b4a.objects.collections.List*/ ;
final int groupLen9 = group9.getSize()
;int index9 = 0;
;
for (; index9 < groupLen9;index9++){
_col = (JHS.zxScannerLiveView.b4xtable._b4xtablecolumn)(group9.Get(index9));
